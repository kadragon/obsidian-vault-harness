...
- [ ] [constraint] `.agents/skills` is text file (mode 100644), not symlink (mode 120000) — proper symlink requires Windows Developer Mode or admin; enable Developer Mode then: `cd .agents && ln -s ../.claude/skills skills && git add skills` (source: pr-review-toolkit, codex) **[BLOCKED: Developer Mode OFF]**
